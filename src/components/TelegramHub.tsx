...
export const TEMPLATE_DEFINITIONS: TemplateDefinitionItem[] = [
  ...
  {
    key: 'lateEntryBlocked',
    category: 'registration',
    categoryLabel: 'رسائل البداية والتسجيل',
    categoryBadge: 'bg-rose-500/10 border-rose-500/30 text-rose-400',
    title: '7. رسالة دخول متأخر (التقيد بالوقت مفعل - منع الإجابة)',
    shortDesc: 'تنبيه الطالب المتأخر بعد انتهاء الوقت بقفل التمارين ومراجعة الإدارة',
    description: 'تُرسل تلقائياً للطالب إذا دخل متأخراً بعد انتهاء مدة الحصة وكان خيار (التقيد بالوقت وقفل التمارين) مفعلاً لإعلامه بقفل الأنشطة والتواصل مع الإدارة.',
    iconName: 'Lock',
    supportedVars: [
      { tag: '{{اسم_الطالب}}', label: 'اسم الطالب' },
      { tag: '{{رقم_الطالب}}', label: 'الرقم الدراسي' },
      { tag: '{{وقت_الحصة}}', label: 'موعد الحصة المقرر' },
      { tag: '{{الوقت_الفعلي}}', label: 'وقت الدخول الفعلي' },
    ],
    sampleVars: { studentName: 'أحمد علي', studentId: '101', classTime: '19:00', actualTime: '21:30' },
  },
  {
    ...
    title: '8. رسالة دخول متأخر (التقيد بالوقت معطل - إتاحة التمارين)',
    shortDesc: 'تنبيه الطالب بتسجيل دخوله متأخراً مع السماح له بحل التمارين',
    description: 'تُرسل تلقائياً للطالب إذا دخل متأخراً بعد انتهاء وقت الحصة وكان خيار (التقيد بالوقت وقفل التمارين) غير مفعل لإعلامه بتسجيل الدخول وإتاحة حل التمارين.',
    iconName: 'Sparkles',
    supportedVars: [
      { tag: '{{اسم_الطالب}}', label: 'اسم الطالب' },
      { tag: '{{رقم_الطالب}}', label: 'الرقم الدراسي' },
